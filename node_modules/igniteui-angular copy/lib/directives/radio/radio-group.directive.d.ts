...
export declare class IgxRadioGroupDirective implements AfterContentInit, AfterViewInit, ControlValueAccessor, OnDestroy, DoCheck {
    ...
    private static ngAcceptInputType_invalid;
    /**
    ...
    */
     ...
     */
    ngOnDestroy(): void;
    constructor(ngControl: NgControl, _directionality: IgxDirectionality);
    /**
     * @hidden
     * @internal
     */
    ...
    static ɵfac: i0.ɵɵFactoryDeclaration<IgxRadioGroupDirective, [{ optional: true; self: true; }, null]>;
